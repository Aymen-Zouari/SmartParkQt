...
class GraphModifier : public QObject
{
    Q_OBJECT
public:
    explicit GraphModifier(Q3DBars *bargraph,QString,QString);
    ~GraphModifier();
    ...
    void setSeries3Visibility(int enabled);
    void setReverseValueAxis(int enabled);
    void setReflection(bool enabled);

public Q_SLOTS:
    void changeRange(int range);
    void affiche2(int range);
...
private:
    ...
    QBar3DSeries *m_secondarySeries2;
    QBar3DSeries *m_secondarySeries3;
